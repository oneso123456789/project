...
/**
 * Servlet implementation class QueryString02
 */
@WebServlet(description = "값전달 연습", urlPatterns = { "/QueryString02" })
public class QueryString02 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println(name);
//		out.println(HanConv.toKor(name));
		out.println("</b><br> 구분 : <b>");
//		out.println(HanConv.toKor(vclass));
		out.println(vclass);
